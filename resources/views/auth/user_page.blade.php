...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="{{ assets('adminlt3') }}/dist/css/adminlte.min.css">
</head>
...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="{{ assets('adminlte3') }}/index2.html" class="h1"><b>Admin</b>LTE</a>
    </div>
    <div class="card-body">
      <p class="login-box-msg">Sign in to start your session</p>

      <form action="{{ assets('adminlte3') }}/index3.html" method="post">
